...
public class JwtUtils {
    ...
    /*Questo metodo genera un token JWT a partire da un oggetto Authentication fornito,
     che rappresenta l'informazione di autenticazione dell'utente*/
    ...
    /*Questo metodo verifica se un token JWT è valido.*/
    ...
    /*Questo metodo estrae l'username dall'interno di un token JWT*/
