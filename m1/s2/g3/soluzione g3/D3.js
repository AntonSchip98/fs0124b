...
*/
for (let el of starWarsCharacters) {
  switch (el.eye_color) {
    case "blue":
      eyeColor.blue.push(el);
      break;
    case "yellow":
      eyeColor.yellow.push(el);
      break;
    case "brown":
      eyeColor.brown.push(el);
      break;
    case "red":
...
for (let character of charactersNames) {
  for (let female of femaleCharacters) {
    if (character === female.name) {
      charactersNames.pop(character);
    }
  }
}
console.log(charactersNames.length);
...
*/
let randomNum = Math.floor(Math.random() * starWarsCharacters.length);
let randomCharacter = starWarsCharacters[randomNum];
console.log(
  "Il personaggio " +
    ...
    (randomCharacter.hair_color === "n/a"
      ? "non ha capelli, "
      : "i suoi capelli sono di colore " + randomCharacter.hair_color + ", ") +
    "il colore della sua 'pelle' è " +
    randomCharacter.skin_color +
    ", i suoi 'occhi' sono di colore " +
